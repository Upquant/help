...
比如:在[initialize](51.html#%E5%BC%95%E5%85%A5etasdk%E9%87%8F%E5%8C%96%E7%AD%96%E7%95%A5%E5%BA%93)中,设置了A股全市场(CS.SET), 但是每天选股过程中只会选取几只股票, 并对这几只股票做买卖操作, 因此只需要`set_focus_symbols`这几只股票, 从而大幅度提升了效率.
...
**说明：** 在策略运行前会调用一次，用来进行初始化各项运行参数,如config配置中已有[initialize](51.html#%E5%BC%95%E5%85%A5etasdk%E9%87%8F%E5%8C%96%E7%AD%96%E7%95%A5%E5%BA%93)配置，则此步骤可省略。
...
**返回值：**[SymbolPosition](51.html#SymbolPosition-%E7%AD%96%E7%95%A5%E7%9A%84%E6%A0%87%E7%9A%84%E6%8C%81%E4%BB%93)对象。
...
**返回值：**list结构，元素为[SymbolPosition](51.html#SymbolPosition-%E7%AD%96%E7%95%A5%E7%9A%84%E6%A0%87%E7%9A%84%E6%8C%81%E4%BB%93)对象。
...
**返回值：**标的所属证券的市场账号信息，[Account](51.html#Account-%E8%B4%A6%E6%88%B7%E4%BF%A1%E6%81%AF)结构。
...
**返回值：**该标的在其所属账户中的总仓位信息，[OverallPosition](51.html#OverallPosition-%E8%B4%A6%E6%88%B7%E7%9A%84%E6%A0%87%E7%9A%84%E6%8C%81%E4%BB%93)对象结构。
...
**返回值：**策略盈亏信息，[StrategyPnL](51.html#StrategyPnL-%E7%AD%96%E7%95%A5%E7%9A%84%E7%9B%88%E4%BA%8F%E4%BF%A1%E6%81%AF)对象结构
...
**返回值：**证券基本信息，[RefData](51.html#RefData-%E8%82%A1%E7%A5%A8%E5%9F%BA%E7%A1%80%E4%BF%A1%E6%81%AF)。
...
**注意：** 调用此api之前需在初始化[initialize](51.html#%E5%BC%95%E5%85%A5etasdk%E9%87%8F%E5%8C%96%E7%AD%96%E7%95%A5%E5%BA%93)中设置所需的symbols和prepared_bars，否则可能取不到字段值。
...
| -------------- | ----------- | -------- | ------------------------------------------------------------ |
| symbol         | str         | 是       | 标的代码                                                     |
| time_span      | ETimeSpan   | 是       | bar的频率，详见 [ETimeSpan](41.html#ETimeSpan-%E9%A2%91%E7%8E%87%E7%B1%BB%E5%9E%8B)。 |
| count          | int         | 是       | 获取历史数据条数，超过缓存类型的返回空                       |
| price_mode     | EPriceMode  | 否       | 复权模式，不填默认返回不复权，详见[EPriceMode](41.html#EPriceMode-%E5%A4%8D%E6%9D%83%E6%A8%A1%E5%BC%8F) 。 |
...
获取数值类因子数据。数据信息详见[股票交易指标（日频）](45.html#%E8%82%A1%E7%A5%A8%E4%BA%A4%E6%98%93%E6%8C%87%E6%A0%87%EF%BC%88%E6%97%A5%E9%A2%91%EF%BC%89)。

调用此api之前需在初始化[initialize](51.html#%E5%BC%95%E5%85%A5etasdk%E9%87%8F%E5%8C%96%E7%AD%96%E7%95%A5%E5%BA%93)中设置缓存的symbol和field，否则可能取不到字段值
...
获取股票的财务数据。数据信息详见[股票财务数据（季频）](45.html#%E8%82%A1%E7%A5%A8%E8%B4%A2%E5%8A%A1%E6%95%B0%E6%8D%AE%EF%BC%88%E5%AD%A3%E9%A2%91%EF%BC%89)。

调用此api之前需在初始化[initialize](51.html#%E5%BC%95%E5%85%A5etasdk%E9%87%8F%E5%8C%96%E7%AD%96%E7%95%A5%E5%BA%93)中设置相关股票池和所需因子，否则可能取不到字段值
...
表格类因子数据，数据信息详见[表格型数据](45.html#%E8%A1%A8%E6%A0%BC%E5%9E%8B%E6%95%B0%E6%8D%AE)
...
| ---------- | ---- | -------- | ------------------------------------------------------------ |
| symbol     | str  | 是       | 股票代码                                                     |
| field      | str  | 是       | 因子名 ，详见[因子数据](45.html#%E5%9B%A0%E5%AD%90%E6%95%B0%E6%8D%AE) |
...
![](//cdn.upchina.com/uptest/201811/1543304596835_20181127154316_6e3c29a508fff34a.jpg)

修改步骤：检查配置文件config中的user是否与量化平台右上角的SDK_User一致，若不一致修改之即可。

![](//cdn.upchina.com/uptest/201811/1543304938826_20181127154858_9a44682a5c87ce16.jpg)

2.TOKEN错误

报错信息截图如下：
![](//cdn.upchina.com/uptest/201811/1543305265132_20181127155425_82ecd3b7c6e38a11.jpg)
...
![](//cdn.upchina.com/uptest/201811/1543305840208_20181127160400_bec94241e049f1e5.jpg)
...
![](//cdn.upchina.com/uptest/201811/1543305936452_20181127160536_bd84c0f81dea26e8.jpg)

修改步骤：检查配置文件config中的”name“配置的是否和实例中模块参数下的策略名一致，若不是修改之即可。

![](//cdn.upchina.com/uptest/201811/1543306057927_20181127160737_80e52e74becabea7.jpg)

5.策略ID不存在

报错信息截图如下：

![](//cdn.upchina.com/uptest/201811/1543306409112_20181127161329_bbc192cd1eb38927.jpg)

修改步骤：检查config配置文件中的”instance_id“是否和量化平台界面要运行的实例ID一致，若不一致点击”复制ID“按钮，然后粘贴到config配置文件对应位置即可

![](//cdn.upchina.com/uptest/201811/1543306552419_20181127161552_b64ebcff2360af31.jpg)
...
# API文档  (旧版)
## 一个简单的策略
以下是一个简单的买入标的池中的标的并持有的策略，用来说明一个基本的策略完成所需的模块，更多的策略详见[策略示例](47.html#%E7%AD%96%E7%95%A5%E7%A4%BA%E4%BE%8B)。 
```
from etasdk import *   
#初始化
...
onTick(api,tick)
```
**说明：** [tick](41.html#Tick-Tick%E8%A1%8C%E6%83%85%E4%BF%A1%E6%81%AF "tick")产生时会调用，目前仅期货市场支持tick。
...
```
**说明：** 第一根[tick](41.html#Tick-Tick%E8%A1%8C%E6%83%85%E4%BF%A1%E6%81%AF "tick")产生时会调用，目前仅期货市场支持tick。可用于撮合周期为非tick级别来获取当日涨跌停价，以此做止盈止损，回测不支持此回调。
...
onBar(api,bar)
```
**说明：** 创建实例时设置撮合周期，[bar](41.html#Bar-Bar%E6%95%B0%E6%8D%AE%E4%BF%A1%E6%81%AF)产生时会调用。为了提高效率，只有在关注列表（即[setFocusSymbols](41.html#setFocusSymbols-%E8%AE%BE%E7%BD%AE%E5%85%B3%E6%B3%A8%E7%9A%84%E6%A0%87%E7%9A%84)设置的标的列表）中和有持仓的标的才会响应行情回调。
...
```
**说明：** 针对某一周期的bar数据，搜集齐后再统一响应回调，timeExch为当前周期的时间戳。对于回测，数据可以都到齐；对于模拟盘和实盘，不一定能够都到齐，需要设置超时时间。默认只回调onBar，如需回调onHandleData则需在onInitialize中配置setGroupMode函数，详见[setGroupMode](41.html#setGroupMode-%E8%AE%BE%E7%BD%AE%E5%88%B0%E9%BD%90%E5%9B%9E%E8%B0%83%E6%A8%A1%E5%BC%8F)。
...
bars|list[tuple(ETimeSpan, int)]|否|设置缓存K线条数，可以设置多个频率。频率类型，详见  [ETimeSpan](41.html#ETimeSpan-%E9%A2%91%E7%8E%87%E7%B1%BB%E5%9E%8B)
...
只能在[onBeforeMarketOpen](41.html#onBeforeMarketOpen-%E7%9B%98%E5%89%8D%E8%BF%90%E8%A1%8C)函数中调用，必须实现。只有在此函数中进行设置的标的和当前持仓的标的才会在[onBar](41.html#onBar-Bar%E4%BA%A7%E7%94%9F)、[onHandleData](41.html#onHandleData-%E6%95%B0%E6%8D%AE%E5%88%B0%E9%BD%90%E5%90%8E%E8%A7%A6%E5%8F%91)或者[onTick](41.html#onTick-tick%E4%BA%A7%E7%94%9F)函数中进行行情响应。若没有在setFocusSymbols中set的标的并且不在持仓的不会在[onBar](41.html#onBar-Bar%E4%BA%A7%E7%94%9F)、[onHandleData](41.html#onHandleData-%E6%95%B0%E6%8D%AE%E5%88%B0%E9%BD%90%E5%90%8E%E8%A7%A6%E5%8F%91)和[onTick](41.html#onTick-tick%E4%BA%A7%E7%94%9F)中响应，并且调用getBarsHistory也拿不到当天的K线。
...
### setSymbolPool-设置股票池
在onInitialize函数中调用，只有在此函数中进行设置相关股票，才能获取到对该股票设置缓存的相关K线和其他因子数据以及财务数据。股票池可以设置单个标的，也可以设置[指数成分股](45.html#%E8%82%A1%E7%A5%A8%E6%8C%87%E6%95%B0%E4%BB%A3%E7%A0%81)、[行业板块](45.html#%E8%82%A1%E7%A5%A8%E8%A1%8C%E4%B8%9A%E6%9D%BF%E5%9D%97%E4%BB%A3%E7%A0%81)、[特殊集合](45.html#%E7%89%B9%E6%AE%8A%E9%9B%86%E5%90%88%E7%BA%A6%E5%AE%9A)。
...
在onInitialize函数中调用，设置Bar行情数据的数据缓存条数，即[getBarsHistory](41.html#getBarsHistory-%E8%8E%B7%E5%8F%96%E5%8E%86%E5%8F%B2K%E7%BA%BF%E6%95%B0%E6%8D%AE)函数中可以调用的历史条数，在初始化事件中进行调用。例如将日K线设置成5，则可以获取到前5个交易日的数据，随着回测时间移动之前的数据会被清掉。若需要取用多个频率的数据则需要分别设置，不设置该函数不会缓存。
...
参数 |类型| 说明
---|---|---
timspan| ETimeSpan|Bar的频率类型，详见 [ETimeSpan](41.html#ETimeSpan-Bar%E7%9A%84%E9%A2%91%E7%8E%87%E7%B1%BB%E5%9E%8B) 。
...
在onInitialize函数中调用，设置缓存日频、季频、财务数据字段，即[getFieldsOneDay](41.html#getFieldsOneDay-%E8%8E%B7%E5%8F%96%E5%A4%9A%E5%8F%AA%E8%82%A1%E7%A5%A8%E6%9F%90%E4%B8%80%E4%B8%AA%E4%BA%A4%E6%98%93%E6%97%A5%E7%9A%84%E6%95%B0%E6%8D%AE)、[getFieldsRangeDays](41.html#getFieldsRangeDays-%E8%8E%B7%E5%8F%96%E4%B8%80%E5%8F%AA%E8%82%A1%E7%A5%A8%E5%A4%9A%E4%B8%AA%E4%BA%A4%E6%98%93%E6%97%A5%E7%9A%84%E6%95%B0%E6%8D%AE)、[getFieldsCountDays](41.html#getFieldsCountDays-%E8%8E%B7%E5%8F%96%E4%B8%80%E5%8F%AA%E8%82%A1%E7%A5%A8%E7%9A%84%E5%A4%9A%E6%9D%A1%E6%95%B0%E6%8D%AE)和[getStockFinFields](41.html#getStockFinFields -%E8%8E%B7%E5%8F%96%E8%B4%A2%E5%8A%A1%E6%95%B0%E6%8D%AE) 函数中可以调用的字段。例如设置"TOT_SHARE", "SP_RESER"，则调用前面的函数中就可以取到这两个字段的值，否则取不到值。不设置该函数就不会缓存。
...
在onInitialize函数中调用，若不调用本函数，则只响应[onBar](41.html#onBar-Bar%E4%BA%A7%E7%94%9F)。
...
onlyGroup| bool|是|True-只回调[onHandleData](41.html#onHandleData-%E6%95%B0%E6%8D%AE%E5%88%B0%E9%BD%90%E5%90%8E%E8%A7%A6%E5%8F%91)  ，False- 既回调[onHandleData](41.html#onHandleData-%E6%95%B0%E6%8D%AE%E5%88%B0%E9%BD%90%E5%90%8E%E8%A7%A6%E5%8F%91)也回调[onBar](41.html#onBar-Bar%E4%BA%A7%E7%94%9F)
...
在onInitialize函数中调用，设置[onTimer](41.html#onTimer-%E5%AE%9A%E6%97%B6%E5%99%A8)定时回调函数的响应周期。在回测环境下无效。
**函数原型：**
```
setTimerCycle(cycle)
```
...
positionSide| EPositionSide| 否|	多或者空，不填时默认为多仓，股票不能为short。详见 [EPositionSide](41.html#EPositionSide-%E6%8C%81%E4%BB%93%E6%96%B9%E5%90%91) 
tif| ETimeInForce| 否|下单属性说明，不填和填None时效果相同，详见[ETimeInForce-订单委托属性](41.html#ETimeInForce-%E8%AE%A2%E5%8D%95%E5%A7%94%E6%89%98%E5%B1%9E%E6%80%A7)
remark | str| 否|下单原因说明，填写后可以在web端展示
priceList| EtaPriceList| 否|报价列表，用于下限价单。若与price同时传参，则以price为准，详见[EtaPriceList-报价列表](41.html#EtaPriceList-%E6%8A%A5%E4%BB%B7%E5%88%97%E8%A1%A8)
...
---|--- |---|---
symbol  |str |是| 标的代码
EPositionSide| positionSide| 否|	多或者空，不填时默认为多仓，股票不能为short。详见[EPositionSide](41.html#EPositionSide-%E6%8C%81%E4%BB%93%E6%96%B9%E5%90%91) 。

**返回值：**[SymbolPosition](41.html#SymbolPosition-%E7%AD%96%E7%95%A5%E6%8C%81%E4%BB%93%E4%BF%A1%E6%81%AF)对象。
...
**返回值：**List结构，元素为[SymbolPosition](41.html#SymbolPosition-%E7%AD%96%E7%95%A5%E6%8C%81%E4%BB%93%E4%BF%A1%E6%81%AF)对象。
...
**返回值：**标的所属证券的市场账号信息，[Account](41.html#Account-%E8%B4%A6%E6%88%B7%E4%BF%A1%E6%81%AF)结构。
...
**返回值：**该标的在其所属账户中的总仓位信息，[OverallPosition](41.html#OverallPosition-%E8%B4%A6%E6%88%B7%E7%9A%84%E6%A0%87%E7%9A%84%E6%8C%81%E4%BB%93)对象结构。
...
**返回值：**策略盈亏信息，[StrategyPnL](41.html#StrategyPnL-%E7%AD%96%E7%95%A5%E7%9A%84%E7%9B%88%E4%BA%8F%E4%BF%A1%E6%81%AF)对象结构
...
获取K线数据。模拟盘和实盘在[onHandleData](41.html#onHandleData-%E6%95%B0%E6%8D%AE%E5%88%B0%E9%BD%90%E5%90%8E%E8%A7%A6%E5%8F%91)和[onBar](41.html#onBar-Bar%E4%BA%A7%E7%94%9F)中获取当天的日K不是全日K线，是开盘时间到所设置的收盘时间的日K。
...
---|---  |---|---
symbol | str |是| 标的代码
timeSpan | ETimeSpan| 是|bar的频率，详见 [ETimeSpan](41.html#ETimeSpan-%E9%A2%91%E7%8E%87%E7%B1%BB%E5%9E%8B)。
count |int |是| 获取历史数据条数，超过缓存类型的返回空
priceMode| EPriceMode|否|复权模式，不填默认返回不复权，详见[EPriceMode](41.html#EPriceMode-%E5%A4%8D%E6%9D%83%E6%A8%A1%E5%BC%8F) 。
...
**返回值：**行情数据 ,df为false时返回[Bar](41.html#Bar-Bar%E6%95%B0%E6%8D%AE%E4%BF%A1%E6%81%AF)结构List。df为true时返回dataFrame格式。
...
**返回值：**证券基本信息，[RefData](41.html#RefData-%E8%82%A1%E7%A5%A8%E5%9F%BA%E7%A1%80%E4%BF%A1%E6%81%AF)。
...
获取股票的股本、市值等信息，主要是日频和部分季频因子数据。数据信息详见[股票交易指标（日频）](45.html#%E8%82%A1%E7%A5%A8%E4%BA%A4%E6%98%93%E6%8C%87%E6%A0%87%EF%BC%88%E6%97%A5%E9%A2%91%EF%BC%89)和[股票财务数据（季频）](45.html#%E8%82%A1%E7%A5%A8%E8%B4%A2%E5%8A%A1%E6%95%B0%E6%8D%AE%EF%BC%88%E5%AD%A3%E9%A2%91%EF%BC%89)。
...
获取一只股票多个交易日的股本、市值等信息。数据信息详见[股票交易指标（日频）](45.html#%E8%82%A1%E7%A5%A8%E4%BA%A4%E6%98%93%E6%8C%87%E6%A0%87%EF%BC%88%E6%97%A5%E9%A2%91%EF%BC%89)和[股票财务数据（季频）](45.html#%E8%82%A1%E7%A5%A8%E8%B4%A2%E5%8A%A1%E6%95%B0%E6%8D%AE%EF%BC%88%E5%AD%A3%E9%A2%91%EF%BC%89)。
...
获取单只股票基于某个交易日的前n条股本、市值等数据。数据信息详见[股票交易指标（日频）](45.html#%E8%82%A1%E7%A5%A8%E4%BA%A4%E6%98%93%E6%8C%87%E6%A0%87%EF%BC%88%E6%97%A5%E9%A2%91%EF%BC%89)和[股票财务数据（季频）](45.html#%E8%82%A1%E7%A5%A8%E8%B4%A2%E5%8A%A1%E6%95%B0%E6%8D%AE%EF%BC%88%E5%AD%A3%E9%A2%91%EF%BC%89)。
...
获取单只标单个交易日的表格型数据，数据信息详见[表格型数据](45.html#%E8%A1%A8%E6%A0%BC%E5%9E%8B%E6%95%B0%E6%8D%AE)
...
---|---|---|---
 symbol    | str  | 是| 股票代码
 field| str  | 是| 表格名 ，详见[表格型数据](45.html#%E8%A1%A8%E6%A0%BC%E5%9E%8B%E6%95%B0%E6%8D%AE) 
 tradeDate | int  | 否| 指定某个交易日，不填则默认为回测上一交易日。形式为YYYYMMDD
 columns| list | 否| 返回的字段；为空时,默认返回所有列,否则返回指定的列 
 df    | bool | 否  | 返回是否采用dataFrame格式，默认为True                 
...
调用此api之前需在初始化onInitialize中setRequireData设置股票和所需[表格型数据](45.html#%E8%A1%A8%E6%A0%BC%E5%9E%8B%E6%95%B0%E6%8D%AE) ，不然取不到字段值
